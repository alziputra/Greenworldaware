...
const News = () => {
  ...
  // Ambil berita utama (item pertama) dari data news
  const mainNews = news.length > 0 ? news[0] : null;
  const otherNews = news.slice(1); // Sisanya adalah berita lainnya
      ...
      <div className="md:max-w-[1480px] m-auto max-w-[600px] px-4 md:px-0">
        ...
        {mainNews && (
          <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 gap-8 max-w-[600px] items-center pt-10 px-4 md:px-10">
            <img src={mainNews.image || "https://via.placeholder.com/650x400"} className="w-[650px] mx-auto" alt="Main News" />
